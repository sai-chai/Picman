...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [SerializeField] private AudioClip m_ChewingSound;
        
        private GameController m_Global;
        ...
        private void Start()
        {
            ...
            c_speed = 0f;
            m_Global = GameObject.FindWithTag("GameController").GetComponent<GameController>();
        }
        ...
        {
            if (!m_CharacterController.isGrounded || m_AudioSource.isPlaying)
            {
                return;
            }
